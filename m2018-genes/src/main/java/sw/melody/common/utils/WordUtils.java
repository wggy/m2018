...
public class WordUtils {
    ...
    public static void main(String[] args) {
        ...
        params.put("name", "小明");
        params.put("sex", "男");
        params.put("address", "软件园");
        params.put("phone", "88888888");
        ...
        try {
            ...
            String path = "G:/address.docx";  //模板文件位置
            String fileName = new String("G:/测试文档.docx".getBytes("UTF-8"), "iso-8859-1");    //生成word文件的文件名
