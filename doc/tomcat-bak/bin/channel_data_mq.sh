...
export CATALINA_OUT=/data/logs/tomcat/nubia_data_mq.out
export LOGGING_CONFIG="-Djava.util.logging.config.file=../conf/logging.properties"
export SERVER_CONF="-config conf/channel_data_mq_8093.xml"
...
JAVA_OPTS='-server -Xrs -Xmx4G -Xms4G -Xss256k -XX:NewSize=1G -XX:MaxNewSize=1G -XX:+DisableExplicitGC -XX:+UseConcMarkSweepGC -XX:+CMSParallelRemarkEnabled -XX:LargePageSizeInBytes=128m -XX:+UseFastAccessorMethods -XX:+UseCMSInitiatingOccupancyOnly -XX:CMSInitiatingOccupancyFraction=70 -XX:SurvivorRatio=8 -Xverify:none -Djava.net.preferIPv4Stack=true -Dfile.encoding=UTF-8 -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.authenticate=false -Djava.rmi.server.hostname=10.206.2.180 -Dcom.sun.management.jmxremote.port=11999 -XX:+UnlockCommercialFeatures -XX:+FlightRecorder'
