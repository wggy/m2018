 ...
 * Generated at: 2016-01-28 06:25:11 UTC
...
public final class viewOperation_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("<body>\r\n");
      out.write("\t<form>\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"operationId\" value=\"");
      ...
      out.write("\" />\r\n");
      out.write("\t\t<dl>\r\n");
      out.write("\t\t\t<b>操作名称 <span>*</span></b>\r\n");
      out.write("\t\t\t<span><input name=\"name\" style=\"width:280px;\" maxlength=\"16\" value=\"");
      ...
      out.write("\t\t</dl>\r\n");
      out.write("\t\t<dl>\r\n");
      out.write("\t\t\t<b>唯一标识 <span>*</span></b>\r\n");
      out.write("\t\t\t<span><input name=\"uniqueId\" style=\"width:280px;\" maxlength=\"32\" value=\"");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<dl>\r\n");
      out.write("\t\t\t<b>描述 <span>*</span></b>\r\n");
      out.write("\t\t\t<span><input name=\"description\" style=\"width:280px;\" maxlength=\"255\" value=\"");
      ...
      out.write("\tvar frm=$('form:eq(0)'),nv=frm[0].name.value,uniqueId=frm[0].uniqueId.value;\r\n");
      out.write("\tif($.trim(uniqueId)==''){\r\n");
      out.write("\t\ttop.tip(-1,'唯一标识不能为空');\r\n");
      out.write("\t}else if($.trim(nv)==''){\r\n");
      out.write("\t\ttop.tip(-1,'操作名称不能为空');\r\n");
      out.write("\t}else{\r\n");
      out.write("\t\t$.post('saveOperation.action',frm.serialize(),function(r){\r\n");
      out.write("\t\t\tif(r=='isexist'){\r\n");
      out.write("\t\t\t\ttop.tip(-1,'唯一标识已存在，请重新输入！');\r\n");
      out.write("\t\t\t}else{\r\n");
