 ...
 * Generated at: 2016-01-07 11:05:56 UTC
...
return;
    ...
    try {
      ...
      out.write("\" />\n");
      out.write("\t\t<dl>\n");
      out.write("\t\t\t<b>角色名称 <span>*</span></b>\n");
      out.write("\t\t\t<span><input name=\"name\" style=\"width:280px;\" maxlength=\"32\" value=\"");
      ...
      out.write("\t\t</dl>\n");
      out.write("\t\t<dl>\n");
      out.write("\t\t\t<b>角色描述 <span>*</span></b>\n");
      out.write("\t\t\t<span><input name=\"description\" style=\"width:280px;\" maxlength=\"64\" value=\"");
      ...
      out.write("\tvar frm=$('form:eq(0)'),nv=frm[0].name.value,dv=frm[0].description.value;\n");
      out.write("\tif($.trim(nv)==''){\n");
      out.write("\t\ttop.tip(-1,'角色名称不能为空');\n");
      out.write("\t}else if($.trim(dv)==''){\n");
      out.write("\t\ttop.tip(-1,'角色描述不能为空');\n");
      out.write("\t}else{\n");
      out.write("\t\t$.post('saveRole.action',frm.serialize(),function(r){\n");
