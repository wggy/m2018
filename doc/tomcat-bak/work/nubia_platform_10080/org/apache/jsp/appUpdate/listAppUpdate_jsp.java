 ...
 * Generated at: 2016-03-07 07:04:39 UTC
...
public final class listAppUpdate_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th style=\"width: 30px;\">应用名称</th>\r\n");
      out.write("\t\t\t\t<th style=\"width: 130px;\">APK名称</th>\r\n");
      out.write("\t\t\t\t<th style=\"width: 130px;\">包名</th>\r\n");
      out.write("\t\t\t\t<th style=\"width: 30px;\">verName</th>\r\n");
      out.write("\t\t\t\t<th style=\"width: 30px;\">verCode</th>\r\n");
      out.write("\t\t\t\t<th style=\"width: 30px;\">应用大小</th>\r\n");
      out.write("\t\t\t\t<th style=\"width: 80px;\">更新时间</th>\r\n");
      out.write("\t\t\t\t<th style=\"width: 80px;\">更新内容</th>\r\n");
      ...
      out.write("\t\t\t}else{\r\n");
      out.write("\t\t\t   \r\n");
      out.write("\t\t\t\tvar data = $('<tr class=\"data\"><td colspan=\"9\">数据正在加载中，请稍候...</td></tr>')\r\n");
      out.write("\t\t\t\t\t.insertAfter(this.parentNode.parentNode);\r\n");
      out.write("\t\t\t\tthis.data = data;\r\n");
      out.write("\t\t\t\tvar args = this.hash.replace('#', '').split(',');\r\n");
      out.write("\t\t\t\t$.get('../appUpdate/listAppUpdateListInner.action?appUpdateId=' + args[0], function(r){\r\n");
      out.write("\t\t\t\t\tvar r = $(r);\r\n");
      ...
      out.write("\t\t\tlocation.href=\"../appUpdate/viewAppUpdate.action\";\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tlocation.href=\"../appUpdate/viewAppUpdate.action?appUpdateId=\"+id;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction detail(id){\r\n");
      out.write("\t\ttop.win('应用详细信息','../appUpdate/detailAppUpdate.action?appUpdateId='+id,400,260);\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction del(id,evt){\r\n");
      out.write("\t\ttop.del('../appUpdate/delAppUpdate.action?appUpdateId='+id,evt);\r\n");
      out.write("\t}\r\n");
      out.write("\tfunction delList(id,evt){\r\n");
      out.write("\t\ttop.del('../appUpdate/delAppUpdateList.action?appUpdateListId='+id,evt);\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /appUpdate/listAppUpdate.jsp(25,4) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/appUpdate/listAppUpdate.jsp(25,4) '${list}'",_el_expressionfactory.createValueExpression(_jspx_page_context.getELContext(),"${list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /appUpdate/listAppUpdate.jsp(25,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setVar("appUpdate");
    // /appUpdate/listAppUpdate.jsp(25,4) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.appUpdateId}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("\"></a>\r\n");
          out.write("\t\t\t\t\t\t\t");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.appName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("\r\n");
          out.write("\t\t\t\t\t\t</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.apkName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.packageName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.verName}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.verCode}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.appSize}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          ...
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.content}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("\t\t\t\t\t\t<td>\r\n");
          out.write("\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /appUpdate/listAppUpdate.jsp(36,10) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatDate_005f0.setValue((java.util.Date) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${appUpdate.addTime}", java.util.Date.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
    // /appUpdate/listAppUpdate.jsp(36,10) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_fmt_005fformatDate_005f0.setType("date");
    // /appUpdate/listAppUpdate.jsp(36,10) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_rbac_005fprivilege_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /appUpdate/listAppUpdate.jsp(39,7) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_rbac_005fprivilege_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    // /appUpdate/listAppUpdate.jsp(42,7) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_rbac_005fprivilege_005f1.setTest("delOpt");
  ...
  private boolean _jspx_meth_rbac_005fprivilege_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /appUpdate/listAppUpdate.jsp(52,3) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_rbac_005fprivilege_005f2.setTest("addOpt");
    ...
    if (_jspx_eval_rbac_005fprivilege_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t\t\t\t<input type=\"button\" value=\"添加应用\" onclick=\"view()\" class=\"btn_default\" />\r\n");
        out.write("\t\t\t");
