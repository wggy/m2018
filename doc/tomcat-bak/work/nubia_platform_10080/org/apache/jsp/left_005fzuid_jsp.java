 ...
 * Generated at: 2016-03-07 06:45:21 UTC
...
public final class left_005fzuid_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
  ...
  private boolean _jspx_meth_rbac_005fprivilege_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /left_zuid.jsp(3,0) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    _jspx_th_rbac_005fprivilege_005f0.setTest("zuid/statUserNum.action");
    ...
    if (_jspx_eval_rbac_005fprivilege_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\r\n");
        out.write("\t<!-- <li class=\"active\"><a href=\"../zuid/statUserNum.action\">当前用户数量</a></li> -->\r\n");
        out.write("\t<li class=\"active\"><a href=\"../zuid/statUserNumByLogin.action\">用户登录情况</a></li>\r\n");
        out.write("\t<li><a href=\"../zuid/statRegisterWay.action\">注册方式统计</a></li>\r\n");
        out.write("\t<li><a href=\"../zuid/statRegisterArea.action\">区域分布统计</a></li>\r\n");
        out.write("\t<li><a href=\"../pn/statApnNum.action\">消息推送统计</a></li>\r\n");
        out.write("\t<li><a href=\"../pn/statSmsNum.action\">短信统计</a></li>\r\n");
