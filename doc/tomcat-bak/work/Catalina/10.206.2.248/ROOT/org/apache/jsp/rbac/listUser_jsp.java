 ...
 * Generated at: 2017-01-16 09:11:48 UTC
...
return;
    ...
    try {
      ...
      out.write("        <h2 class=\"page-header\">系统用户管理</h2>\n");
      out.write("        <div>\n");
      out.write("            ");
      ...
      out.write("    <script src=\"/rbac/listUser.js?v=20160728\"></script>\n");
      out.write("</body>\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_rbac_005fprivilege_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /rbac/listUser.jsp(22,12) name = test type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    if (_jspx_eval_rbac_005fprivilege_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        out.write("\n");
        out.write("                <button id=\"add-user-btn\" class=\"btn btn-primary vertical-gap\">添加管理员</button>\n");
        out.write("            ");
