 ...
 * Generated at: 2016-04-18 01:36:13 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t\t<th data-field=\"state\" data-checkbox=\"true\"></th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th data-field=\"id\" data-visible=\"false\">id</th>\n");
      out.write("\t\t\t\t\t\t\t\t\t<th data-field=\"appId\">应用Id</th>\n");
      ...
      out.write("\t\t\t}\n");
      out.write("\t\t\tif(res.response) {\n");
      out.write("\t\t\t\t$.each(res.response, function(i, row) {\n");
      out.write("\t\t\t\t\trow.state = $.inArray(row.id, menuIds) !== -1;\n");
      out.write("\t\t\t\t});\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\treturn res.response;\n");
      out.write("\t\t}\n");
      out.write("\n");
      ...
      out.write("\t\t\tif(app.response) {\n");
      out.write("\t\t\t\tif(selectIds == \"0\" || selectIds[0] == 0) {\n");
      out.write("\t\t\t\t\t$.each(app.response, function(i, row) {\n");
      out.write("\t                     row.state = true;\n");
      out.write("\t                });\n");
      out.write("\t\t\t\t\t$(\"#select-all\")[0].checked=true;\n");
      out.write("\t\t\t\t\treturn app.response;\n");
      out.write("\t            }\n");
      out.write("\t\t\t\telse {\n");
      out.write("\t\t\t\t\t$(\"#select-all\").removeAttr(\"checked\");\n");
      out.write("\t\t\t\t\t$.each(app.response, function(i, row) {\n");
      out.write("\t\t\t\t\t\t row.state = ($.inArray(row.id, selectIds) !== -1);\n");
      out.write("\t\t\t\t\t\t var Time = new Date(row.createTime);\n");
      out.write("\t\t\t\t\t\t row.createTime = Time.format(\"yyyy-MM-dd hh:mm:ss\");\n");
      out.write("\t\t\t\t\t});\n");
      out.write("\t\t\t\t}    \n");
      out.write("\t\t\t}\n");
      out.write("\t\t\treturn app.response;\n");
