 ...
 * Generated at: 2015-11-03 08:29:48 UTC
...
import com.ztemt.framework.common.*;
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_packages.add("com.ztemt.framework.common");
...
return;
	...
	if(sysuser==null){
		...
		if(workId!=null){
			sysuser=Cache.get(DES.decrypt(workId));
			if(sysuser!=null){
				response.sendRedirect(request.getContextPath()+"/workspace/workspace.zte");
			}
		}
	}else{
		response.sendRedirect(request.getContextPath()+"/workspace/workspace.zte");
      ...
      out.write("\t}else{\n");
      out.write("\t\t$.post(\"login/check.zte\",frm.serialize(),function(r){\t\t\t\t\n");
      out.write("\t\t\tif(r==\"success\"){\n");
      out.write("\t\t\t\t$.cookie.set(cookieName,uv,2678400);\n");
      out.write("\t\t\t\ttop.location.href=\"workspace/workspace.zte\";\n");
      ...
      out.write("</div>\n");
      out.write("\n");
      out.write("<div id=\"copyright\">2012 © 深圳市中兴移动通信有限公司</div>\n");
      out.write("</body>\n");
      out.write("</html>");
